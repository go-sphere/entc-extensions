...
const file_entpb_entpb_proto_rawDesc = "" +
	"\n" +
	"\x11entpb/entpb.proto\x12\x05entpb\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa4\x02\n" +
	"\x04Post\x12\x0e\n" +
	...
	"\x04role\x18\v \x01(\rR\x04roleB\x87\x01\n" +
	"\tcom.entpbB\n" +
	"EntpbProtoP\x01Z:github.com/go-sphere/protoc-gen-entconv/testdata/api/entpb\xa2\x02\x03EXX\xaa\x02\x05Entpb\xca\x02\x05Entpb\xe2\x02\x11Entpb\\GPBMetadata\xea\x02\x05Entpbb\x06proto3"
...
var file_entpb_entpb_proto_depIdxs = []int32{
	...
	3, // 1: entpb.User.birthday:type_name -> google.protobuf.Timestamp
