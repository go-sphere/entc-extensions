...
func main() {
	opts := &entconv.Options{
		...
		EntPackagePath:    "github.com/go-sphere/protocgenentconv/testdata/internal/pkg/database/ent",
		ProtoFile:         "./api/entpb/entpb.pb.go",
		ConvPackage:       "converter",        // 生成的 package 名
		ProtoPackagePath:  "github.com/go-sphere/protocgenentconv/testdata/api/entpb",
