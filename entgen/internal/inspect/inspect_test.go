...
func TestGenerateZeroCheckExpr(t *testing.T) {
	tests := []struct {
		...
		{reflect.StructField{Name: "Name", Type: reflect.TypeOf("")}, `source.Name == ""`},
		{reflect.StructField{Name: "Age", Type: reflect.TypeOf(int(0))}, `source.Age == 0`},
		{reflect.StructField{Name: "Active", Type: reflect.TypeOf(false)}, `!source.Active`},
		{reflect.StructField{Name: "Email", Type: reflect.TypeOf((*string)(nil))}, `source.Email == nil`},
		{reflect.StructField{Name: "Score", Type: reflect.TypeOf(float64(0))}, `source.Score == 0.0`},
	}
