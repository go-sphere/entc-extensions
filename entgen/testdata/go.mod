module github.com/go-sphere/entc-extensions/entgen/testdata

go 1.26.0

replace github.com/go-sphere/entc-extensions/entgen => ../

replace github.com/go-sphere/entc-extensions/autoproto => ../../autoproto
